...
class ReportFloodDetailScreen extends StatefulWidget {
  final Map<String, dynamic> laporan;

  const ReportFloodDetailScreen({super.key, required this.laporan});

  @override
  State<ReportFloodDetailScreen> createState() => _ReportFloodDetailScreenState();
}

class _ReportFloodDetailScreenState extends State<ReportFloodDetailScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailCard(
              ...
              content: widget.laporan['penyebab_banjir'] ?? '-',
            ),
            _buildDetailCard(
              title: 'Dampak Banjir',
              content: widget.laporan['dampak_banjir'] ?? '-',
            ),
 ...
 'Laporan Palsu',
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.blue.shade600, // Menyesuaikan dengan tema banjir
