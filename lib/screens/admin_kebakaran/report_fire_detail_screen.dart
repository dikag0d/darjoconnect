...
class ReportFireDetailScreen extends StatefulWidget {
  final Map<String, dynamic> laporan;

  const ReportFireDetailScreen({super.key, required this.laporan});

  @override
  State<ReportFireDetailScreen> createState() => _ReportFireDetailScreenState();
}

class _ReportFireDetailScreenState extends State<ReportFireDetailScreen> {
  String? selectedStatus;

  @override
  void initState() {
    super.initState();
    selectedStatus = widget.laporan['status'];
  }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'success') {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Gagal memperbarui status: ${data['message']}')),
          );
        }
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.red, // Mengubah warna menjadi merah untuk kebakaran
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailCard(
              ...
              content: widget.laporan['penyebab_kebakaran'] ?? '-',
            ),
            _buildDetailCard(
              title: 'Dampak Kebakaran',
              content: widget.laporan['dampak_kebakaran'] ?? '-',
            ),
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.red.shade600, // Menyesuaikan dengan tema kebakaran
