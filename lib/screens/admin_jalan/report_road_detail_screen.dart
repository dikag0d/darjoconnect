...
class ReportRoadDetailScreen extends StatefulWidget {
  final Map<String, dynamic> laporan;

  const ReportRoadDetailScreen({super.key, required this.laporan});

  @override
  State<ReportRoadDetailScreen> createState() => _ReportRoadDetailScreenState();
}

class _ReportRoadDetailScreenState extends State<ReportRoadDetailScreen> {
  ...
  Future<void> updateStatus() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (data['status'] == 'success') {
        ...
        // Kembali ke halaman utama dan memberi tahu bahwa data telah diperbarui
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDetailCard(
              ...
              content: widget.laporan['penyebab_kerusakan_jalan'] ?? '-',
            ),
            _buildDetailCard(
              title: 'Dampak Kerusakan',
              content: widget.laporan['dampak_kerusakan_jalan'] ?? '-',
            ),
            ...
            if (widget.laporan['image_url'] != null &&
                widget.laporan['image_url'].isNotEmpty)
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text(
